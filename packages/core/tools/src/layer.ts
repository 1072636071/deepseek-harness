/**
 * One scope's aggregate tool-registry layer: registrations, compiled
 * restrictions, and monotonic guards.
 * @module
 */

import { AnonymousEntries, NamedEntries } from '@deepseek-ai/dsh-scope'
import type { ScopeKey, ScopeLayer } from '@deepseek-ai/dsh-scope'
import type { ToolDefinition, ToolExecution, ToolGuard, CompiledToolRestriction } from './definition.ts'
import type { ToolPresentationMode } from './config.ts'
